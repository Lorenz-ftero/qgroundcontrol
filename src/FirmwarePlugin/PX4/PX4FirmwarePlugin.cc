...
const char* PX4FirmwarePlugin::tractionfteroFlightMode = "Traction ftero";
...
static const struct Modes2Name rgModes2Name[] = {
    ...
    { PX4_CUSTOM_MAIN_MODE_TRACTION_FTERO,    0,                                PX4FirmwarePlugin::tractionfteroFlightMode, true,   true,   true },
